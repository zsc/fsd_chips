...
关键软件特性：
- **TensorRT 8.0**：自动优化和部署深度学习模型
- **CUDA 11.4**：完整GPU编程支持
- **cuDNN 8.2**：优化的深度学习原语库
- **安全引导**：硬件信任根和安全启动链

### 2.1.6 早期客户与量产进展

2021年，多家车企宣布采用Orin平台：
- **蔚来ET7**：首发4颗Orin芯片，总算力1016 TOPS
- **理想L9**：双Orin方案，支持高速NOA
- **小鹏P5/G9**：单Orin配置，城市NGP功能
- **Mercedes-Benz**：下一代S级采用Orin
- **Volvo/Polestar**：新一代电动平台标配
